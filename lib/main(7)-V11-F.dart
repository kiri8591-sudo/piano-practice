// V11-F — Planning + fiche Morceau finalisation
import 'dart:async';
import 'dart:convert';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(children: [
                                  Icon(Icons.track_changes_outlined, size: 16, color: Theme.of(c).colorScheme.onSecondaryContainer),
                                  const SizedBox(width: 7),
                                  Expanded(child: Text('À renforcer : ${_weakestStepLabel(p)}', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Theme.of(c).colorScheme.onSecondaryContainer))),
                                ]),
                              ),
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      if (p.currentTempo > 0 && p.targetTempo > 0) ...[
                                        ...
                                        const SizedBox(height: 4),
                                        Text(
                                          p.currentTempo >= p.targetTempo ? '🎯 Objectif de tempo atteint' : 'Encore ${p.targetTempo - p.currentTempo} BPM à gagner',
                                          style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Theme.of(c).colorScheme.onSurfaceVariant),
                                        ),
                                      ],
                                    ])),
            ...
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                if (currentTempo > 0 && targetTempo > 0) ...[
                  ...
                  const SizedBox(height: 4),
                  Text(tempoProgress >= 1 ? '🎯 Objectif de tempo atteint' : 'Progression vers le tempo cible',
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Row(children: [
                                              Expanded(child: Text(x.title, style: TextStyle(fontWeight: FontWeight.bold, decoration: x.completed ? TextDecoration.lineThrough : null))),
                                              if (x.completed)
                                                const Padding(padding: EdgeInsets.only(left: 6), child: Icon(Icons.check_circle, size: 17, color: Colors.green)),
                                            ]),

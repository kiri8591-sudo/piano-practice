...
class _PianoPracticeAppState extends State<PianoPracticeApp> {
  ...
  Future<void> proposeWeeklyPlan() async {
    ...
    setState(() {
      // Une nouvelle génération repart proprement de zéro pour le planning futur :
      // toutes les séances planifiées NON TERMINÉES, y compris celles restées
      // en retard d'une ancienne semaine (ex. 31/8 -> 6/9), sont supprimées.
      // Les séances déjà réalisées sont conservées pour préserver l'historique,
      // les statistiques et les éventuelles données d'avancement.

// V203 — Finition fiche morceau iPhone : hiérarchie, progression, objectif et focus mieux lisibles.
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                            ...
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Row(children: [
                                Expanded(child: Text('${s.duration} min · ${s.type}', maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: phoneSession ? 12.5 : 12, fontWeight: FontWeight.w800))),

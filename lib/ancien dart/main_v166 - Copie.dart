...
class _PianoPracticeAppState extends State<PianoPracticeApp> {
  ...
  // V166 : conserver les choix Filtrer / Trier de « Maîtrise des morceaux »
  // lors des reconstructions de l'écran et des changements d'onglet.
            ...
            Builder(builder: (context) {
              ...
              return Column(
                ...
                children: [
                  if (compact)
                    Column(children: [
                      dropdown('Afficher', _masteryFilter, const ['Tous', 'En cours', 'Priorités', 'Entretien', 'Avec Run-through', 'Sans pratique 7 j'], (v) {
                        if (v != null) setState(() => _masteryFilter = v);
                      }),
                      const SizedBox(height: 8),
                      dropdown('Trier par', _masterySort, const ['Maîtrise croissante', 'Maîtrise décroissante', 'Progression', 'Tempo', 'Run-through', 'Régularité', 'Dernière séance', 'Nom', 'Priorité d’abord'], (v) {
                        if (v != null) setState(() => _masterySort = v);
                      }),
                    ])
                  else
                    Row(children: [
                      Expanded(child: dropdown('Afficher', _masteryFilter, const ['Tous', 'En cours', 'Priorités', 'Entretien', 'Avec Run-through', 'Sans pratique 7 j'], (v) {
                        if (v != null) setState(() => _masteryFilter = v);
                      })),
                      const SizedBox(width: 10),
                      Expanded(child: dropdown('Trier par', _masterySort, const ['Maîtrise croissante', 'Maîtrise décroissante', 'Progression', 'Tempo', 'Run-through', 'Régularité', 'Dernière séance', 'Nom', 'Priorité d’abord'], (v) {
                        if (v != null) setState(() => _masterySort = v);
                      })),
                    ]),
                  const SizedBox(height: 10),

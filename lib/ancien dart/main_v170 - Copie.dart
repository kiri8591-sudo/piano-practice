                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Expanded(child: Text(d.isCancelledAfterRealization ? 'Séance annulée' : (d.status == 'removed' ? 'Séance retirée' : d.title), style: const TextStyle(fontWeight: FontWeight.w800))),
                                          if (d.isCancelledAfterRealization)
                                            const Icon(Icons.undo_rounded, size: 17),
                                        ],
                                      ),
                                      const SizedBox(height: 2),
                                      Text(d.isCancelledAfterRealization
                                          ...
                                          : (d.status == 'removed'
                                              ...
                                              : 'Analyse : ${_coachDateTimeLabel(analysisDate)}'), style: const TextStyle(fontSize: 12)),
                                    ],
                                  ),
                                ),
                            ...
                            if (d.isCancelledAfterRealization) ...[
                              ...
                              const SizedBox(height: 2),
                              Text('Cette séance a été décochée dans « Ton programme ». Son analyse reste conservée pour garder l’historique du coach.', style: TextStyle(color: Theme.of(c).colorScheme.onSurfaceVariant, fontSize: 12, height: 1.35)),
                            ] else if (d.status == 'removed') ...[
                              const SizedBox(height: 8),
                              const Text('Statut', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800)),
                              const SizedBox(height: 2),
                              Text('Cette séance a été retirée de l’historique. L’analyse du coach est conservée pour mémoire.', style: TextStyle(color: Theme.of(c).colorScheme.onSurfaceVariant, fontSize: 12, height: 1.35)),
                            ],
                            if (d.changed) ...[

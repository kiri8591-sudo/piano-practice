      ...
      body: ListView(
        ...
        children: [
          ...
          CardBox(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (tempoMeasured.isNotEmpty) ...[
              ...
              for (final e in (tempoMeasured.entries.toList()..sort((a, b) => (a.value / a.key.targetTempo).compareTo(b.value / b.key.targetTempo))).take(5)) ...[
                Row(children: [Text(e.key.emoji), const SizedBox(width: 7), Expanded(child: Text(e.key.name, style: const TextStyle(fontWeight: FontWeight.w600))), Text('${e.value}/${e.key.targetTempo} BPM')]),
                const SizedBox(height: 5),
          ...
          if (ranked.isNotEmpty) ...[
            const SizedBox(height: 16),
            CardBox(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              _sectionHeader(c, Icons.auto_awesome, 'Les 3 prochaines actions du coach', subtitle: 'Pour savoir immédiatement quoi travailler en priorité.'),
              const SizedBox(height: 10),
              for (final p in ranked.take(3))
                Padding(
                  padding: const EdgeInsets.only(bottom: 10),
                  child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(p.name, style: const TextStyle(fontWeight: FontWeight.w700)),
                            const SizedBox(height: 2),
                            Text(coachReason(p), style: TextStyle(fontSize: 11.5, color: Theme.of(c).colorScheme.primary, fontWeight: FontWeight.w600)),
                            const SizedBox(height: 2),
                            Text(coachAction(p), style: TextStyle(fontSize: 10.5, color: Theme.of(c).colorScheme.onSurfaceVariant)),
                            const SizedBox(height: 2),
                            Text(lastWorkLabel(p), style: TextStyle(fontSize: 10, color: Theme.of(c).colorScheme.onSurfaceVariant.withOpacity(.8))),
                          ])),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton.icon(
                        ...
                        label: Text('Démarrer · ${recommendedMinutes(p)} min'),
                      ),
                    ),
                  ]),
                ),

      ...
      body: ListView(
        ...
        children: [
          ...
          CardBox(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 12),
            Builder(builder: (context) {
              var masteryFilter = 'Tous';
              var masterySort = 'Maîtrise croissante';
              return StatefulBuilder(builder: (context, setMasteryState) {
                  ...
                  if (compact)
                    Column(children: [
                      dropdown('Afficher', masteryFilter, const ['Tous', 'En cours', 'Priorités', 'Entretien', 'Avec Run-through', 'Sans pratique 7 j'], (v) {
                        if (v != null) setMasteryState(() => masteryFilter = v);
                      }),
                      const SizedBox(height: 8),
                      dropdown('Trier par', masterySort, const ['Maîtrise croissante', 'Maîtrise décroissante', 'Progression', 'Tempo', 'Run-through', 'Régularité', 'Dernière séance', 'Nom', 'Priorité d’abord'], (v) {
                        if (v != null) setMasteryState(() => masterySort = v);
                      }),
                    ])
                  else
                    Row(children: [

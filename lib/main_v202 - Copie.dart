        ...
        child: widget.items.isEmpty
            ...
            : sorted.isEmpty
                ...
                : ListView.separated(
                    ...
                    separatorBuilder: (_, __) => SizedBox(height: phone ? 8 : 10),
                    itemBuilder: (_, i) {
                      final p = sorted[i];
                      ...
                      return swipeToDelete(
                        ...
                        child: CardBox(
                          padding: EdgeInsets.all(phone ? (compact ? 13 : 15) : 18),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(children: [
                                ...
                                if (p.currentTempo > 0 || p.targetTempo > 0)
                                  Text(
                                    p.currentTempo > 0 && p.targetTempo > 0 ? '${p.currentTempo} → ${p.targetTempo} BPM' : '${p.currentTempo > 0 ? p.currentTempo : p.targetTempo} BPM',
                                    style: TextStyle(fontSize: 11.5, fontWeight: FontWeight.w700, color: Theme.of(c).colorScheme.onSurfaceVariant),
                                  ),
                                const Spacer(),
                                if (pieceRunMastery != null)
                                  Text('Run-through ${pieceRunMastery.round()} %', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Theme.of(c).colorScheme.onSurfaceVariant)),
                              ]),
                              if (p.goal.trim().isNotEmpty) ...[
                                ...
                                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                  ...
                                  const SizedBox(width: 6),
                                  Expanded(child: Text(p.goal, maxLines: phone ? 2 : 3, overflow: TextOverflow.ellipsis,
                              ...
                              Row(children: [
                                ...
                                Expanded(child: Text(_weakestStepLabel(p), overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 11.5, fontWeight: FontWeight.w800))),
